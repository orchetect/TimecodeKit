...
class Timecode_UT_Hashable_Tests: XCTestCase {
    ...
    func testHashValue() {
        ...
        XCTAssertEqual(   try "01:00:00:00".toTimecode(at: ._23_976).hashValue,
                          try "01:00:00:00".toTimecode(at: ._23_976).hashValue)
        XCTAssertNotEqual(try "01:00:00:01".toTimecode(at: ._23_976).hashValue,
                          try "01:00:00:00".toTimecode(at: ._23_976).hashValue)
        
        XCTAssertNotEqual(try "01:00:00:00".toTimecode(at: ._23_976).hashValue,
    ...
    func testSet() throws {
        ...
        let tcSet: Set<Timecode> = try ["01:00:00:00".toTimecode(at: ._23_976),
