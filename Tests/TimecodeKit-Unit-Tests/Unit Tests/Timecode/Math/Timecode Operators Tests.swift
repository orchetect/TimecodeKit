...
class Timecode_Operators_Tests: XCTestCase {
    ...
    func testAdd_and_Subtract_Operators() throws {
        ...
        tc =      try Timecode.Components(h: 00, m: 00, s: 00, f: 00).timecode(using: ._30)
        
        tc = try tc + Timecode.Components(h: 00, m: 00, s: 00, f: 05).timecode(using: ._30)
        XCTAssertEqual(tc.components, Timecode.Components(h: 00, m: 00, s: 00, f: 05))
        
        tc = try tc - Timecode.Components(h: 00, m: 00, s: 00, f: 04).timecode(using: ._30)
        ...
        tc +=     try Timecode.Components(h: 00, m: 00, s: 00, f: 05).timecode(using: ._30)
        XCTAssertEqual(tc.components, Timecode.Components(h: 00, m: 00, s: 00, f: 05))
        
        tc -=     try Timecode.Components(h: 00, m: 00, s: 00, f: 04).timecode(using: ._30)
        XCTAssertEqual(tc.components, Timecode.Components(h: 00, m: 00, s: 00, f: 01))
    ...
    func testMultiply_and_Divide_Operators() throws {
        ...
        tc =      try Timecode.Components(h: 01, m: 00, s: 00, f: 00).timecode(using: ._30)
