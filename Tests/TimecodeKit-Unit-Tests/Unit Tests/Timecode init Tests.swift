...
class Timecode_UT_init_Tests: XCTestCase {
    ...
    func testTimecode_init_FrameCountValue_Exactly() throws {
        ...
        let tc = try Timecode(.frames(670907),
                              at: ._30,
                              limit: ._24hours)
    ...
    func testTimecode_init_FrameCount_Exactly() throws {
        ...
        let tc = try Timecode(.init(.frames(670907), base: ._80SubFrames),
                              at: ._30,
                              limit: ._24hours)
    ...
    func testTimecode_init_Components_Exactly() throws{
        ...
        try Timecode.FrameRate.allCases.forEach {
            let tc = try Timecode(TCC(d: 0, h: 0, m: 0, s: 0, f: 0),
                                  at: $0,
                                  limit: ._24hours)
        ...
        try Timecode.FrameRate.allCases.forEach {
            let tc = try Timecode(TCC(d: 0, h: 1, m: 2, s: 3, f: 4),
                              at: $0,
                              limit: ._24hours)
    ...
    func testTimecode_init_String_Exactly() throws {
        ...
        try Timecode.FrameRate.allCases.forEach {
            let tc = try Timecode("00:00:00:00",
                              at: $0,
                              limit: ._24hours)
        ...
        try Timecode.FrameRate.allCases.forEach {
            let tc = try Timecode("01:02:03:04",
                              at: $0,
                              limit: ._24hours)
    ...
    func testTimecode_init_String_Clamping() throws {
        ...
        let tc = try Timecode(clamping: "25:00:00:00",
                              at: ._24,
                              limit: ._24hours)
    ...
    func testTimecode_init_String_ClampingEach() throws {
        ...
        let tc = try Timecode(clampingEach: "25:00:00:00",
                              at: ._24,
                              limit: ._24hours)
    ...
    func testTimecode_init_String_Wrapping() throws {
        ...
        try Timecode.FrameRate.allCases.forEach {
            let tc = try Timecode(wrapping: "25:00:00:00",
                                  at: $0,
                                  limit: ._24hours)
    ...
    func testTimecode_init_String_RawValues() throws {
        ...
        try Timecode.FrameRate.allCases.forEach {
            let tc = try Timecode(rawValues: "99 99:99:99:99.99",
                                  at: $0,
                                  limit: ._24hours)
    ...
    func testTimecode_init_RealTimeValue() throws {
        ...
        try Timecode.FrameRate.allCases.forEach {
            let tc = try Timecode(realTimeValue: 2,
                                  at: $0,
                                  limit: ._24hours)
    ...
    func testTimecode_init_Samples() throws {
        ...
        try Timecode.FrameRate.allCases.forEach {
            let tc = try Timecode(samples: 48000 * 2,
                                  sampleRate: 48000,
                                  at: $0,
                                  limit: ._24hours)
